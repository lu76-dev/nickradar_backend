...
app.get('/api/events/:id/print-back', requireEventAdminAuth, async (req, res) => {
  try {
    ...
    const css = `*{margin:0;padding:0;box-sizing:border-box;}body{background:#e0e0e0;font-family:'Courier New',monospace;}.info{padding:12px 20px;font-size:12px;color:#555;}.page{width:210mm;height:297mm;background:white;margin:20px auto;display:grid;grid-template-columns:repeat(3,1fr);grid-template-rows:repeat(8,1fr);}.cell{border-right:1px solid #999;border-bottom:1px solid #999;display:flex;align-items:center;justify-content:center;padding:2mm 6mm;}.cell:nth-child(3n){border-right:none;}.cell:nth-child(n+22){border-bottom:none;}.cell.empty{background:#f9f9f9;}.instr{display:flex;flex-direction:column;gap:3px;width:100%;}.instr-top{display:flex;align-items:center;justify-content:space-between;width:100%;}.instr-left{display:flex;flex-direction:column;align-items:flex-start;gap:2px;}.instr-logo{height:12px;width:auto;opacity:0.7;}.instr-brand{font-size:10px;font-weight:900;letter-spacing:3px;color:#000;}.instr-qr{width:44px;height:44px;flex-shrink:0;}.instr-steps{display:flex;flex-direction:column;gap:2px;width:100%;}.step{font-size:7.5px;letter-spacing:0.2px;color:#000;font-weight:bold;display:flex;align-items:center;gap:2px;white-space:nowrap;}.sn{color:#000;font-size:7.5px;font-weight:900;flex-shrink:0;}@media print{body{background:white;}.info{display:none;}.page{margin:0;box-shadow:none;}}`;
