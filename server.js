        ...
        if (s) {
          cells += `<div class="sticker">
              ...
              <div class="sticker-bottom">
                <img class="sticker-logo" src="https://app.nickradar.com/nr_logo.png" alt="" />
              </div>
            </div>`;
        } else {
